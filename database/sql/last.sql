...
INSERT IGNORE INTO `address` (`id`, `address`, `nickname`, `address_nick`) VALUES
	(1, '1', 'jin', '집'),
	(2, '2', 'jeong', '111');
...
-- 테이블 데이터 nft_market.auction:~11 rows (대략적) 내보내기
/*!40000 ALTER TABLE `auction` DISABLE KEYS */;
INSERT IGNORE INTO `auction` (`auction_id`, `product_id`, `deadline`, `option`) VALUES
	...
	(16, 12, '2021-11-10 09:00:00', 0),
	(17, 12, '2021-11-10 09:00:00', 0),
	(18, 12, '2021-11-10 09:00:00', 0),
	(19, 12, '2021-11-10 09:00:00', 0),
	(20, 12, '2021-11-10 09:00:00', 0);
...
INSERT IGNORE INTO `auction_history` (`auction_history_id`, `auction_id`, `bidder`, `bid`, `date`, `status`) VALUES
	(8, 10, '11111111', 200, '2021-11-10 10:57:26', 'burial'),
	(9, 11, '11111111', 100, '2021-11-10 10:57:35', 'success'),
	(10, 10, '11111111', 250, '2021-11-10 10:57:26', 'success'),
	(11, 11, '11111111', 101, '2021-11-10 10:57:35', 'bid'),
	(12, 10, '11111111', 300, '2021-11-10 10:57:26', 'bid'),
	(13, 11, '11111111', 102, '2021-11-10 10:57:35', 'bid');
...
INSERT IGNORE INTO `bigcategory` (`code`, `value`) VALUES
	('A1', '남여공용'),
	('B1', '남자 의류'),
	('B2', '남자 속옷/잠옷'),
	('B3', '남자 신발'),
...
-- 테이블 데이터 nft_market.delivery:~10 rows (대략적) 내보내기
/*!40000 ALTER TABLE `delivery` DISABLE KEYS */;
INSERT IGNORE INTO `delivery` (`dlvy_id`, `order_id`, `auction`, `status`, `reciever`, `address`, `request`, `recieve_type`, `phone_number`, `invoice`, `delivery_company`, `ready_date`, `ship_date`, `complete_date`) VALUES
	(1, NULL, 3, '대기', '성진', '1', '빨리', '문앞', '01088888888', NULL, '한진', '2021-11-07 22:47:22', '2021-11-10 17:21:55', NULL),
	(2, NULL, 5, '발송', '정성진', '2', '부탁', '집앞', '0108979846', '1115555', 'cj', '2021-11-07 22:48:05', '2021-11-10 17:21:55', NULL),
	(3, 4, 6, 'delivery', '상엽', '3', 'null', 'directly', '01012345678', '123', '123', '2021-11-10 15:02:34', '2021-11-17 17:30:55', NULL),
	(4, 5, 6, 'delivery', '오상', 'null', 'null', 'directly', '01023456789', '2222222', 'lotte', '2021-11-10 15:03:38', '2021-11-10 17:21:55', NULL),
	(5, 6, 7, 'completed', '인구', '5', 'null', 'indirect', '01034567891', '3333333', 'samsung', '2021-11-10 15:04:29', '2021-11-10 17:21:55', NULL),
	(6, 7, 8, 'completed', '구인', '6', 'null', 'directly', '01045678912', '4444444', 'LG', '2021-11-10 15:05:45', '2021-11-10 17:21:55', NULL),
	(7, 8, 9, 'ready', '곽인구', '7', 'null', 'indirect', '01033333333', '6666666', 'SK', '2021-11-10 15:06:30', '2021-11-10 17:21:55', NULL),
	(14, 10, NULL, 'completed', '11', '경북 구미시 1공단로 15-37 (광평동) 1232', NULL, '문앞', '111111111111111', NULL, NULL, '2021-11-17 15:38:05', NULL, '2021-11-17 18:41:43'),
	(15, 9, NULL, 'ready', 'sdfsdfsdfsdfs', '서울 강북구 4.19로12길 5 (수유동) dddddddddd', NULL, '문앞', 'dddddddddd', NULL, NULL, '2021-11-17 15:40:41', NULL, NULL),
	(16, 12, NULL, 'ready', '2222', '광주 동구 2순환로 575 (지산동)111111111111111', '2222', '문앞,2222', 'sdfsdfsdfsd', NULL, NULL, '2021-11-18 10:43:48', NULL, NULL);
...
INSERT IGNORE INTO `likes` (`product_no`, `nickname`) VALUES
	('A104As0000', 'jin'),
	('A104As0000', 'seong'),
	('A104As0000', 'jeong'),
	('A103As0000', 'seong'),
...
INSERT IGNORE INTO `middlecategory` (`code`, `value`, `big_code`) VALUES
	('01', '티셔츠', 'A1'),
	('02', '맨투맨/후드티', 'A1'),
	('03', '셔츠', 'A1'),
	('04', '바지', 'A1'),
...
-- 테이블 데이터 nft_market.orders:~10 rows (대략적) 내보내기
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT IGNORE INTO `orders` (`order_id`, `product_id`, `price`, `buyer`, `date`, `qty`) VALUES
	(3, 8, 10, 'jin', '2021-11-07 21:18:23', 1),
	(4, 17, 800, 'jin', '2021-11-10 14:54:10', 1),
	...
	(11, 8, 20, '11111111', '2021-11-18 10:34:44', 1),
	(12, 11, 30, '11111111', '2021-11-18 10:43:48', 2);
...
-- 테이블 데이터 nft_market.product:~11 rows (대략적) 내보내기
/*!40000 ALTER TABLE `product` DISABLE KEYS */;
INSERT IGNORE INTO `product` (`product_no`, `name`, `explain`, `creater`, `date`, `likes`, `type`, `total_qty`, `leftover`, `symbol`, `contractAddr`, `tokenURI`) VALUES
	('A103As0000', '셔츠입니다.', '셔츠에요', '11111111', '2021-11-07 20:38:14', 12, 'buy', 1, 0, '', NULL, NULL),
	('A104As0000', '바지', '그냥 바지입니다', '11111111', '2021-11-07 20:44:36', 0, 'buy', 1, 1, '', NULL, NULL),
	('A105As1010', '구찌 긴팔옷', '긴팔원숭이', '11111111', '2021-11-10 10:40:47', 33, 'auction', 1, 1, '', NULL, NULL),
	('A105As1111', '코스 블라우스', '여성옷', '11111111', '2021-11-10 10:33:54', 19, 'buy', 1, 1, '', NULL, NULL),
	('B103Aw1245', '노스페이스 히말라야', '남녀공용 패딩', '11111111', '2021-11-10 10:46:57', 55, 'auction', 1, 1, '', NULL, NULL),
	('B105Aw1221', '캐나다구스 점퍼', '남자옷', '11111111', '2021-11-10 10:39:14', 22, 'auction', 1, 1, '', NULL, NULL),
	('B108Aw0000', '아우터', '아우터입니다.', '11111111', '2021-11-07 20:39:20', 1, 'buy', 1, -1, '', NULL, NULL),
	('B108Aw0001', '나이키 패딩', '남녀공용', '11111111', '2021-11-07 20:39:20', 41, 'buy', 1, 1, '', NULL, NULL),
	('B108Aw0002', '나이키 패딩', '남녀공용', '11111111', '2021-11-07 20:39:20', 42, 'buy', 1, 1, '', NULL, NULL),
	('B108Aw0003', '나이키 패딩', '남녀공용', '11111111', '2021-11-07 20:39:20', 42, 'buy', 1, 1, '', NULL, NULL),
	('B108Aw0006', '나이키 패딩', '남녀공용', 'jeong', '2021-11-07 20:39:20', 42, 'buy', 1, 1, '', NULL, NULL);
...
INSERT IGNORE INTO `product_detail` (`product_id`, `product_no`, `color`, `size`, `qty`, `rest`, `price`) VALUES
	(8, 'A103As0000', 'blue', 'ss', 10, 9, 20),
	(9, 'A103As0000', 'red', 'l', 20, 20, 10),
	(10, 'A103As0000', 'black', 'xl', 20, 20, 20),
	(11, 'B108Aw0000', 'blue', 'l', 20, 18, 30),
...
-- 테이블 데이터 nft_market.product_image:~11 rows (대략적) 내보내기
/*!40000 ALTER TABLE `product_image` DISABLE KEYS */;
INSERT IGNORE INTO `product_image` (`product_no`, `img`) VALUES
	('A104As0000', 'sdfsdf'),
	('A104As0000', 'sadf'),
	('A103As0000', 'safd'),
	('A103As0000', 'sdfsf'),
...
INSERT IGNORE INTO `seller` (`nickname`, `seller_no`, `status`) VALUES
	('jin', 'aa', 1),
	('seong', '545321', 1);
...
INSERT IGNORE INTO `user` (`nickname`, `wallet`, `email`, `picture`) VALUES
